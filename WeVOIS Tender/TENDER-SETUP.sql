...
-- ===========================================================================
--  SECTION 18 - NOT MOVING ALONG WITH THIS ONE
-- ===========================================================================

-- ---------------------------------------------------------------------------
--  NOT MOVING ALONG WITH THIS ONE
--
...
--  Expect:  15  -  3  -  8  -  0  -  15  -  5  -  true
--  tables, regions, org units, standard documents (none - the vault starts
--  empty on purpose), RLS-protected tables, the five drop columns,
